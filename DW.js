function downloadTable() {
    ...
    const request = indexedDB.open(KueDB.dbName, 1);
    request.onsuccess = function (event) {
        const db = event.target.result;
        const transaction = db.transaction([KueDB.storeName], "readonly");
        const store = transaction.objectStore(KueDB.storeName);
        ...
        getAllRequest.onsuccess = function (event) {
            ...
            a.href = url;
            a.download = "data-kue.json"; // Nama file yang diunduh
            a.click();
